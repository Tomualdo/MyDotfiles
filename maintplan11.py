					...
					if mp_database.is_connected():
						...
						if (status[0] == 7): #1 PORUCHA is set
							...
							if(parameter['type']=='WD'):								
								...
								val = (uniqeINCREMENT+"s0",getMP_ID(list_kody_poruch,'Nastavenie dráhy zvaru'),getMP_ID(list_stavy,'V prevádzke'),getMP_ID(list_priorit,'2. Obmedzenie výroby'),machine)
